...
Keeping everything in a single table might seem simpler for a small dataset, but it is not over-engineering; it is a necessity for data integrity. Using our orders_flat.csv as evidence, I strongly refute the position that a single table is sufficient for a growing business.
